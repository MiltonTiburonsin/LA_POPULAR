          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
<img src="{{ asset('img/login.png') }}" alt="" class="img-fluid"> <div class="pt-4 pb-2">
  <p class="text-center text-black medium">
    Comprometidos con tu salud y tu familia desde el 2000
</p>
              ...
              <div class="credits">
                ...
                Desarrollo por <a target="_blank" href="#">CHIPANDA</a>
              </div>
